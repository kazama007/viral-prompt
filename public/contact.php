...
?>
  ...
  <main class="prompt-single" style="max-width:640px;margin:40px auto;padding:0 20px;">
    ...
    <div style="background:#fff;border:1px solid var(--border);border-radius:var(--radius);padding:24px;margin-bottom:24px;box-shadow:var(--shadow-sm);">
      <p style="margin-bottom:12px;font-size:15px;"><strong>💬 WhatsApp Support:</strong> +91 94106 10800</p>
    ...
    <p style="text-align:center;">
      <a href="https://wa.me/919410610800?text=Hello%20VIRAL%20PROMPT%2C%20I%20have%20an%20inquiry" target="_blank" rel="noopener" class="btn btn-green btn-lg btn-block">

...
?>
      ...
      <div class="acc-card" id="membershipCard">
        ...
        <div id="membershipContent" style="display:none;">
          <div style="display:flex;align-items:center;justify-content:space-between;gap:10px;margin-bottom:12px;flex-wrap:wrap;">
            ...
            <span id="accPlanTag" style="font-size:12.5px;font-weight:700;color:var(--primary);background:var(--primary-light);padding:4px 12px;border-radius:999px;">VIP Plan — $5/mo</span>
          </div>
  ...
  <a href="https://wa.me/919131421048?text=Hi%21+I%27m+a+premium+member+of+your+VIRAL+PROMPT+community.+I+need+some+help." target="_blank" rel="noopener" class="wa-float" title="WhatsApp Support">
    ...
    async function loadAccountData() {
      ...
      try {
        ...
        if (isVip) {
          ...
          document.getElementById('accPlanTag').textContent = 'VIP Access — $5/mo';
          ...
          btnGroup.innerHTML = `
            ...
            <a href="https://wa.me/919131421048?text=Hi%21+I%27m+a+PROMPT+MASTER+VIP+subscriber.+I+want+to+extend+my+subscription." target="_blank" rel="noopener" class="btn btn-outline" style="display:inline-flex;align-items:center;gap:6px;">
              💬 Extend on WhatsApp
            </a>
          `;
        } else {
          ...
          btnGroup.innerHTML = `
            <a href="https://wa.me/919131421048?text=Hi%21+I+want+to+activate+VIP+subscription+on+PROMPT+MASTER+for+5+dollars" target="_blank" rel="noopener" class="btn btn-primary" style="background:#25D366;border-color:#25D366;">Activate VIP on WhatsApp ($5/mo)</a>
